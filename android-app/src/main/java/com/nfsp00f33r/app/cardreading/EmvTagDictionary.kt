...
object EmvTagDictionary {
    ...
    val EMV_TAGS = mapOf(
        ...
        // Terminal Transaction Qualifiers (TTQ) and Kernel Support
        "9F60" to "CVC3 (Track1)",
        "9F61" to "CVC3 (Track2)",
        ...
        "9F6C" to "Mag Stripe Application Version Number (Card)",
        ...
        // Proprietary Tags from Proxmark3
        "DF20" to "Issuer Proprietary Bitmap (IPB)",
        "DF3E" to "Unknown Proprietary Tag",
